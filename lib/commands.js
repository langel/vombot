...
module.exports = {
	...
	'!alien': () => { play_audio('aliens.mp3'); },
	'!allnoobs': () => { play_audio('allnoobs.mp3'); },

	'!asshole': function() {
		play_audio('asshole.mp3');
	},

	'!asteroids': function() {
		play_audio('asteroids.mp3');
	},

	'!bangbang': function() {
		play_audio('bangbang.mp3');
	},
	'!bake': () => { play_audio('bake.mp3'); },
	'!bat': () => { play_audio('bat.mp3'); },
	'!believe': function() {
	...
	'!butts': () => { play_audio('butts.mp3'); },

	'!california': function() {
		play_audio('california.mp3');
	},
	'!coffee': () => { play_audio('coffee.mp3'); },
	'!cowabunga': function() {
	...
	'!deadoralive': function() { play_audio('deadoralive.mp3');	},
	'!dollar': function() {	play_audio('dollar.mp3'); },
	'!douche': () => { play_audio('douche.mp3'); },
	'!dropit': function() {	play_audio('dropit.mp3'); },
	'!elstinko': () => { play_audio('elstinko.mp3'); },
	'!flaky': () => { play_audio('flaky.mp3'); },
	'!flipthefuck': function() {
		play_audio('flipthefuck.mp3');
	},
	'!floppies': () => { play_audio('floppies.mp3'); },
	'!flute': () => { play_audio('flute.mp3'); },
	...
	'!laser': () => { play_audio('laser.mp3'); },
	'!lazer': () => { play_audio('laser.mp3'); },
	
	'!letsago': function() {
		play_audio('letsago.mp3');
	},
	'!life': () => { play_audio('life.mp3'); },
	
	'!lo': function() {
		play_audio('lo.mp3');
	},
	'!loddy': () => { play_audio('loddy.mp3'); },
	'!mattszon': function() {
		play_audio('mattszon.mp3');
	},
	
	'!mattzson': () => { play_audio('mattszon.mp3'); },
	'!mattszon': () => { play_audio('mattszon.mp3'); },
	'!mattson': () => { play_audio('mattszon.mp3'); },

	'!monster': function() {
		play_audio('zeldamonster.mp3');
	},
	'!mouth': () => { play_audio('mouth.mp3'); },
	...
	'!queeblo': () => { play_audio('queeblo.mp3'); },

	'!rnr': () => { play_audio('rnr.mp3'); },
	...
	'!squirt': () => { play_audio('squirt.mp3'); },
	'!takeabite': () => { play_audio('takeabite.mp3'); },
	'!this': function(words) {
	...
	'!pixel': () => { play_audio('pixel.mp3'); },
	'!urine': () => { play_audio('urine.mp3'); },
