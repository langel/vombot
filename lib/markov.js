...
let ignorables = ['?', 'a', 'about', 'an', 'and', 'at', 'but', 'cool', 'doing', 'e', 'for', 'from', 'get', 'i', 'in', 'is', 'it', 'its', 'like', 'more', 'not', 'now', 'o', 'of', 'ok', 'on', 'one', 'or', 'really', 'should', 'some', 'that', 'the', 'this', 'to', 'too', 'u', 'was', 'were', 'what', 'with', 'you'];
